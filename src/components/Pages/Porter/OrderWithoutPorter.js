import {
  ...
  const OrderWithoutPorter = (props) => {
    useEffect(() => {
        props.getAllOrdersWithoutPorters()
    }, []);
  
    console.log("props in POI", props);
  
    const porterOrderIndex = props.deliverable.map((orders) => {
      console.log(orders);
      ...
      <Flex width="full" align="center" justifyContent="center">
        <Box p={2}>
          ...
          >
            <Center>
              <Heading size="lg">
                <Text fontSize="6xl">Orders Needing Porters</Text>
              </Heading>
            </Center>
            {/* <Link to={`/order/new`}>
  ...
  export default OrderWithoutPorter;
